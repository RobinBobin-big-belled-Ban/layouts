...
const showMore = document.querySelector(".t-button-show-more")
const navPanel = document.querySelector(".t-nav__container")



const secondSwiperInit = () => {
  secondSwiper = new Swiper('.t-nav', {
    pagination: {
...
showMore.addEventListener("click", () => {
  showHiddenContent(navPanel, "t-nav__container--large", showMore)
})
